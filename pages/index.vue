    ...
    <v-row>
        ...
        <v-col cols="12" md="5">
                ...
                <v-card-text v-if="isResult && txtWho && txtWhat && txtWhere && txtWhen">
                    <v-row v-for="y in [0, 1]">
                        <v-col v-for="x in [0, 1]">
                            <v-img
                                :src="`https://butchi.github.io/sd-wwww/sd-img/${txtWho},_${txtWhat}_in_${txtWhere}_in_${txtWhen}/seed_${1 + x + 2 * y}_${('00000' +(1 + x + 2 * y)).slice(-5)}.png`"
            ...
            <v-card v-else :loading="isInLoad">
                ...
                <v-card-text v-if="isResult && txtWho && txtWhat && txtWhere && txtWhen">
                    <v-img
                        :src="`https://butchi.github.io/sd-wwww/sd-img/${txtWho},_${txtWhat}_in_${txtWhere}_in_${txtWhen}/seed_${curIdx}_${('00000' + curIdx).slice(-5)}.png`"
                        class="grey lighten-2">
                    </v-img>
                </v-card-text>
                <v-card-text v-else-if="txtWho || txtWhat || txtWhere || txtWhen">
                    <v-img max-width="512" max-height="512" aspect-ratio="1" class="d-flex align-center text-center">
                        <v-progress-circular indeterminate color="grey lighten-5"></v-progress-circular>
                    </v-img>
                </v-card-text>
